...
<div class="card">
    <div class="card-body text-center py-5">
        ...
        <button type="button" class="btn btn-primary btn-lg" id="btn-install-faq">
...
document.addEventListener('DOMContentLoaded', function () {
    var btn = document.getElementById('btn-install-faq');
    if (!btn) return;
    ...
    btn.addEventListener('click', function () {
        ...
        MubloRequest.requestJson('/admin/faq/install', {})
            .then(function (res) {
