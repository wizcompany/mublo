...
<div class="card">
    <div class="card-body text-center py-5">
        <i class="bi bi-grid-1x2" style="font-size:3rem; color:#6c757d;"></i>
        ...
        <button type="button" class="btn btn-primary btn-lg" id="btn-install-widget">
...
document.addEventListener('DOMContentLoaded', function () {
    var btn = document.getElementById('btn-install-widget');
    if (!btn) return;
    ...
    btn.addEventListener('click', function () {
        ...
        MubloRequest.requestJson('/admin/widget/install', {})
            .then(function (res) {
                location.href = '/admin/widget/list';
            })
            .catch(function (err) {
                btn.disabled = false;
