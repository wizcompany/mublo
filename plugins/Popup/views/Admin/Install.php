...
<div class="card">
    <div class="card-body text-center py-5">
        ...
        <button type="button" class="btn btn-primary btn-lg" id="btn-install-popup">
...
document.addEventListener('DOMContentLoaded', function () {
    var btn = document.getElementById('btn-install-popup');
    if (!btn) return;
    ...
    btn.addEventListener('click', function () {
        ...
        MubloRequest.requestJson('/admin/popup/install', {})
            .then(function (res) {
