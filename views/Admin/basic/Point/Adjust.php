...
<div class="page-container">
    ...
    <div class="sticky-header">
        <div class="row align-items-end page-navigation">
            <div class="col-sm">
                <h3 class="fs-4 mb-0"><?= htmlspecialchars($pageTitle ?? '포인트 수동 조정') ?></h3>
                <p class="text-muted mb-0">회원에게 포인트를 지급하거나 차감합니다.</p>
            </div>
            <div class="col-sm-auto my-2 my-sm-0">
                <a href="/admin/point" class="btn btn-default">
        ...
        <div class="card-body">
            <form id="adjustForm">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="/admin/point" class="btn btn-default btn-lg">취소</a>
                </div>
            </form>
        </div>
    </div>
