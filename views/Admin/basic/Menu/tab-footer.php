...
<div class="card mt-3">
    <div class="px-3 pt-3 pb-0 fw-semibold d-flex justify-content-between align-items-center" style="font-size:0.9rem">
        <span><i class="bi bi-layout-text-sidebar me-2 text-pastel-green"></i>푸터 메뉴</span>
        <button type="button" class="btn btn-primary btn-sm" id="btn-save-footer">
    ...
    <div class="card-body p-0">
        <div class="row g-0">
            ...
            <div class="col-md-7 p-3">
                ...
                <div id="footer-list" style="min-height:80px; background:var(--bs-secondary-bg); border-radius:6px; padding:6px;">
